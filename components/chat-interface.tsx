...
export default function ChatInterface({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Normalizar mensajes antes de crear el prompt
      ...
      if (!response.body) {
        throw new Error("No hay cuerpo de respuesta disponible");
      }
      ...
      await processStream(reader, async (chunk) => {
        ...
        for (const message of messages) {
          console.log("Mensaje SSE recibido:", message);

          if (!message || !message.type) {
            console.warn("Mensaje SSE inválido:", message);
            continue;
          }
          ...
          switch (message.type) {
            ...
            case StreamMessageType.ToolStart:
              if ("tool" in message && "input" in message) {
                ...
                console.warn("ToolStart inválido:", message);
              }
              break;
            ...
            case StreamMessageType.ToolEnd:
              if ("tool" in message && "output" in message && currentTool) {
                ...
                console.warn("ToolEnd inválido o currentTool no definido:", message);
              }
              break;
            ...
            case StreamMessageType.Error:
              if ("error" in message) {
                ...
                console.warn("Error inválido:", message);
              }
              break;
