...
export function MessageBubble({ content, isUser }: MessageBubbleProps) {
  ...
  if (!content || content.trim() === "") {
    console.warn("El contenido del mensaje está vacío o no es válido. No se renderizará nada.");
    return (
      <div className="text-gray-500 italic">El bot no generó una respuesta válida.</div>
    );
  }
